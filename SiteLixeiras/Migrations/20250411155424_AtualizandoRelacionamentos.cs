...
{
    /// <inheritdoc />
    public partial class AtualizandoRelacionamentos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco = table.Column<string>(type: "nvarchar(999)", maxLength: 999, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnderecoEntrega", x => x.EnderecoEntregaId);
                    table.ForeignKey(
                        name: "FK_EnderecoEntrega_AspNetUsers_UsuarioId",
